...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Hospitie</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
       ...
       @if (Route::has('login'))
                    ...
                    <span class="mx-3 ml-4 btn  btn-primary d-none d-md-inline">
                        <a href="{{ url('/dashboard') }}" class="text-sm text-white  underline">Dashboard</a>
                  </span>

                        @else

                         <span class="   btn btn-primary d-none d-md-inline">
                        <a href="{{ route('login') }}" class="text-sm text-white  underline">Log in</a>
                        </span>

                        @if (Route::has('register'))

                         <span class="mx-3   btn btn-primary d-none d-md-inline">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="row">
          ...
          @php
            $services = App\Models\MedService::all();
          @endphp
          @foreach ($services as $service)
          <div style="width: 416px; height: 337px" >
            <div class="icon-box">
        ...
        <form action="forms/appointment.php" method="post" role="form" class="php-email-form">
          ...
          <div class="row">
            <div class="col-md-12 form-group mt-3">
              <input type="datetime" name="date" class="form-control datepicker" id="search" placeholder="Hospital name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>

                      <div style="width: 800px; margin-left: 25px; z-index: 1000; margin-top: 10px; position: absolute; " class=" clearfix" >
  ...
  {{-- modal for order details --}}
            ...
            {{-- <div class="col-md-4 form-group mt-3">
              <select   name="department" id="selectState" class="form-select">
                <option value="">Select State</option>
              </select>
              <div class="validate"></div>
            </div>
            <div class="col-md-4 form-group mt-3">
              <select  name="doctor" id="lga" class="form-select">
        ...
        <div class="row gy-4">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
                @php
                $departments = App\Models\Department::all()->take(5);
                @endphp
                @foreach ($departments as $department)
            <li class="nav-item">
                            <a class="nav-link active show" data-bs-toggle="tab" href="#{{$department->name}}">{{$department->name}}</a>
                        </li>
                @endforeach
          ...
          <div class="col-lg-9">
            <div class="tab-content">
                 ...
                 @foreach ($departments as $department)
             <div class="tab-pane active show" id="{{$department->name}}">
                <div class="row gy-4">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>{{$department->name}}</h3>
                    <p class="fst-italic">{{$department->shortDescription}}</p>
                    <p>{{$department->longDescription}}</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="{{url('upload/department/'.$department->image)}}" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
                @endforeach
    ...
    <section id="doctors" class="doctors">
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6"  >
            <div style="height: 293px; width: 636px" class="member d-flex align-items-start">
              <div class="pic">
                <img src="{{url('upload/doctor/'.$doctor->image)}}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>{{$doctor->name}}</h4>
                <span>{{$doctor->title}}</span>
                <p>{{$doctor->description}}</p>
                <div class="social">
                  <a href="{{$doctor->socialLink1}}"><i class="ri-twitter-fill"></i></a>
                  <a href="{{$doctor->socialLink2}}"><i class="ri-facebook-fill"></i></a>
                  <a href="{{$doctor->socialLink3}}"><i class="ri-instagram-fill"></i></a>
                  <a href="{{$doctor->socialLink3}}"> <i class="ri-linkedin-box-fill"></i> </a>
                </div>
              </div>
            </div>
          </div>
